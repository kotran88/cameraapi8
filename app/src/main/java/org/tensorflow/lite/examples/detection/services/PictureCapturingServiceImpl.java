...
//    }
    ...
    public void startCapturing(final PictureCapturingListener listener) {
        ...
        try {
            ...
            for(int i =0; i<cameraIds.length; i++){
                Log.e(TAG,cameraIds[i]);
            }
            Log.e(TAG,cameraIds.toString()+"start capture"+cameraIds.length);
            if (cameraIds.length > 0) {
                Log.e(TAG,"yes camera");
    ...
    private void openCamera() {
        Log.e(TAG, "opening camera " + currentCameraId);
        try {
...
//            cameraClosed = false;
//            Log.e(TAG, "camera " + camera.getId() + " opened");
//            cameraDevice = camera;
                Log.e(TAG, "Tatatatataking picture from camera " + camera.getId());
    ...
    private void takePicture() throws CameraAccessException {
        ...
        Log.e("testing88","take picture come");
    ...
    private void saveImageToDisk(final byte[] bytes) {
        ...
        Log.e("testing88","saveImageTodisk"+cameraId.toString());
